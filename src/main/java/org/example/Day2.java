...
public class Day2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while((line = br.readLine()) != null){
            ...
            if(!line.isEmpty()){
                ...
                score = score + instance.getScoreChoice(choices[1]);
                String new_choice = instance.get_end_choice(choices[0], choices[1]);
                score2 = score2 + instance.getScoreChoice(new_choice);
    ...
    private int getScoreChoice(String a){
        if(a.compareTo("Z") == 0){
            return 3;
    ...
    private int game_score(String elf, String challenger){
        String check = elf + challenger;
